...
![Schematic representation of a watershed. *(Source: Adapted from Karambiri et Diello, 2008)*](images/watershed.png){#fig-Rbenefits width=50% fig-alt="Illustration of a watershed"}
