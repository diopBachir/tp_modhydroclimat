...
![Schematic representation of a watershed. *(Source: Adapted by Bodian et al. (2012) from Karambiri et Diello, 2008)*](images/watershed.png){#fig-Rbenefits width=75% fig-alt="Illustration of a watershed"}
...
![Conceptual framework of the bias correction pathway for climate model projections [@Chun2012].](images/biascorr_illustr.png){#fig-biascorr width=100% fig-alt="Bias correction Illustr"}
...
![Evapotranspiration: sum of evaporation from water bodies and land surfaces plus transpiration from plants, such as trees and grasses. (Image by LabXchange © The President and Fellows of Harvard College)](images/pet-illustr.png){#fig-pet width=100% fig-alt="Schematic of the PET physics"}
