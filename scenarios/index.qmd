...
Let's plot the mean daily and monthly  discharge for the historical, RCP4.5 and RCP8.5 simulations. We source, in the chunk below, the [**`compute_mean_daily_cycle(...)`**](https://github.com/diopBachir/tp_modhydroclimat/blob/main/helper_functions/compute_mean_daily_cycle.R) helper function.
